					...
					c.validator,
					{
						...
						messages : {
							...
							maxlength : c.validator
									.format("Mật khẩu quá dài."),
							minlength : c.validator
									.format("Mật khẩu quá yếu."),
						...
						prototype : {
							...
							optional : function(a) {
								if (a.type == 'password') {
									// alert(!c.validator.methods.required.call(this,a.value,
						...
						methods : {
							...
							email : function(a, b) {
								...
								return this.optional(b) || re.test($.trim(a))
							},
							url : function(a, b) {
								return this.optional(b)
