		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="./">
					...
					<div class="space"></div> <!-- <div id="vtapp">Viettel App Store</div> -->
	...
	<div class="register stacked">
		<div class="row">
			<div class="row-same-height">
				...
				<div class="col-sm-6 col-xs-6 col-md-6 col-lg-6 col-xlg-10">
						...
						<form id="regiter_form" action="" method="post" novalidate="novalidate" class="fv-form fv-form-bootstrap">
							...
							<div class="login-fields">
								...
								<div class="field form-group">
									<label for="email"> Email : </label> <input type="text" id="email" name="email" value="" placeholder="Email" class="form-control" data-fv-emailaddress="true" data-fv-notempty="true"
										data-fv-notempty-message="This field is required." data-fv-field="email"> <small class="help-block" data-fv-validator="emailAddress" data-fv-for="email"
										data-fv-result="NOT_VALIDATED" style="display: none;">Please enter a valid email address</small><small class="help-block" data-fv-validator="notEmpty" data-fv-for="email"
										data-fv-result="NOT_VALIDATED" style="display: none;">This field is required.</small>
								</div>
								<!-- /field -->
								<div class="field form-group">
								...
								Platform Default
								<div class="field btn-group form-group">
									<a id="platformDefault" class="gender-fields btn btn-default dropdown-toggle btn-select" data-toggle="dropdown" href="#"> Android <span class="caret"></span>
									</a>
									<ul class=" dropdown-menu">
										<li><a>iOS</a></li>
										<li class="divider"></li>
							...
							<div class="login-actions form-group">
								<span class="form-group login-checkbox"> <input id="checktt" name="checktt" type="checkbox" tabindex="4" data-fv-notempty="true"
									data-fv-notempty-message="You must agree to the terms and conditions." data-fv-field="checktt"> <label for="checktt"> I agree to the <a id="term_condition" style="">
											Vmock Terms</a> of User.
								</label> <small class="help-block" data-fv-validator="notEmpty" data-fv-for="checktt" data-fv-result="NOT_VALIDATED" style="display: none;">You must agree to the terms and conditions.</small></span>
								<!-- 
