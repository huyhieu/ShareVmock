var App = function () {
    var e = "", t = !1, a = !1, i = !1, o = !1, n = [], r = function () {
        ...
        var e = $(window).width();
        if (768 > e)a = !0, jQuery("#main-content").addClass("margin-left-0"); else {
        ...
        var e = $(".sidebar-menu");
        if (1 === e.parent(".slimScrollDiv").size() && (e.slimScroll({destroy: !0}), e.removeAttr("style"), $("#sidebar").removeAttr("style")), 0 === $(".sidebar-fixed").size())return c(), void 0;
        var t = s();
        if (t.width >= 992) {
    ...
    var g = function () {
        ...
        for (var e = [], t = "New York,Los Angeles,Chicago,Houston,Paris,Marseille,Toulouse,Lyon,Bordeaux,Philadelphia,Phoenix,San Antonio,San Diego,Dallas,San Jose,Jacksonville".split(","), a = 0; a < t.length; a++)e.push({id: a, name: t[a], status: a % 2 ? "Already Visited" : "Planned for visit", coolness: Math.floor(10 * Math.random()) + 1});
        ...
        jQuery("#rowed3").jqGrid({data: e, datatype: "local", height: 250, colNames: ["Inv No", "Date", "Client", "Amount", "Tax", "Total", "Notes"], colModel: [
            {name: "id", index: "id", width: 55},
            {name: "invdate", index: "invdate", width: 90, editable: !0},
            {name: "name", index: "name", width: 100, editable: !0},
            {name: "amount", index: "amount", width: 80, align: "right", editable: !0},
            {name: "tax", index: "tax", width: 80, align: "right", editable: !0},
            {name: "total", index: "total", width: 80, align: "right", editable: !0},
            {name: "note", index: "note", width: 150, sortable: !1, editable: !0}
        ], rowNum: 10, rowList: [10, 20, 30], pager: "#prowed3", sortname: "id", viewrecords: !0, sortorder: "asc", editurl: "server.html", caption: "Inline navigator", autowidth: !0}), jQuery("#rowed3").jqGrid("navGrid", "#prowed3", {edit: !1, add: !1, del: !1}), jQuery("#rowed3").jqGrid("inlineNav", "#prowed3"), $(".navtable .ui-pg-button").tooltip({container: "body"})
    }, R = function () {
        ...
        function e() {
            ...
            ], o = [0, 1, 0, 2], n = 0, r = d3.time.format("%A"), s = new xChart("line-dotted", i[o[n]], "#chart1", {axisPaddingTop: 5, dataFormatX: function (e) {
                return new Date(e)
        ...
        function t() {
            {
                var e = {xScale: "time", yScale: "linear", type: "line", main: [
                    {className: ".pizza", data: [
                        {x: "2012-11-05", y: 1},
                        {x: "2012-11-06", y: 6},
                        {x: "2012-11-07", y: 13},
                        {x: "2012-11-08", y: -3},
        ...
        function a() {
            ...
            {
                var i = {xScale: "time", yScale: "linear", main: [
                    {className: ".pizza", data: [
                        {x: "2012-11-05", y: 6},
                        {x: "2012-11-06", y: 6},
                        {x: "2012-11-07", y: 8},
        ...
        function i() {
            {
                var e = {xScale: "ordinal", yScale: "linear", main: [
                    {className: ".pizza", data: [
                        {x: "Pepperoni", y: 4},
                        {x: "Cheese", y: 8}
                    ]}
        ...
        function n() {
            ...
            var a = [
                {xScale: "ordinal", yScale: "linear", main: [
                    {className: ".errorExample", data: [
                        {x: "Ponies", y: 12},
                        {x: "Unicorns", y: 23},
                        {x: "Trolls", y: 1}
                    ]}
                ], comp: [
                    {type: "error", className: ".comp.errorBar", data: [
                        {x: "Ponies", y: 12, e: 5},
                        {x: "Unicorns", y: 23, e: 2},
                        {x: "Trolls", y: 1, e: 1}
                    ]}
            ...
            ], i = new xChart("bar", a[0], "#chart6"), o = 0;
            e()
        }
        ...
        var a = new Date, i = a.getDate(), o = a.getMonth(), n = a.getFullYear(), r = $("#calendar").fullCalendar({header: {left: "prev,next today", center: "title", right: "month,agendaWeek,agendaDay"}, selectable: !0, selectHelper: !0, select: function (e, t, a) {
            ...
            {title: "BBQ Party", start: new Date(n, o, 1), backgroundColor: Theme.colors.blue},
            {title: "Benny's Cuisine Deals", start: new Date(n, o, i - 5), end: new Date(n, o, i - 2), backgroundColor: Theme.colors.red},
            {id: 999, title: "Springbreak Cajun", start: new Date(n, o, i - 3, 16, 0), allDay: !1, backgroundColor: Theme.colors.yellow},
            {id: 999, title: "Crawfish deal", start: new Date(n, o, i + 4, 16, 0), allDay: !1, backgroundColor: Theme.colors.primary},
            {title: "Halloween", start: new Date(n, o, i, 10, 30), allDay: !1, backgroundColor: Theme.colors.green},
            {title: "Lunch Deals", start: new Date(n, o, i, 12, 0), end: new Date(n, o, i, 14, 0), allDay: !1, backgroundColor: Theme.colors.red},
            {title: "Birthday Party Deals", start: new Date(n, o, i + 1, 19, 0), end: new Date(n, o, i + 1, 22, 30), allDay: !1, backgroundColor: Theme.colors.gray},
            {title: "Awesome Deals", start: new Date(n, o, 28), end: new Date(n, o, 29), backgroundColor: Theme.colors.green}
        ]})
    }, it = function () {
        var e = function (e) {
        ...
        function e() {
            ...
            var t = [
                ...
                {data: a, label: "Pageviews", bars: {show: !0, fill: !0, barWidth: .4, align: "center", lineWidth: 13}},
                {data: t, label: "Visits", lines: {show: !0, lineWidth: 2}, points: {show: !0, lineWidth: 2, fill: !0}, shadowSize: 0},
                {data: t, label: "Visits", lines: {show: !0, lineWidth: 1, fill: !0, fillColor: {colors: [
                    {opacity: .05},
                    {opacity: .01}
                ]}}, points: {show: !0, lineWidth: .5, fill: !0}, shadowSize: 0}
            ], {grid: {hoverable: !0, clickable: !0, tickColor: "#f7f7f7", borderWidth: 0, labelMargin: 10, margin: {top: 0, left: 5, bottom: 0, right: 0}}, legend: {show: !1}, colors: ["rgba(109,173,189,0.5)", "#70AFC4", "#DB5E8C"], xaxis: {ticks: 5, tickDecimals: 0, tickColor: "#fff"}, yaxis: {ticks: 3, tickDecimals: 0}}), null);
        ...
        function a() {
            ...
            var t = [
                ...
                [11, 100 * Math.random()],
                [12, 100 * Math.random()]
            ], a = $(this).parent().parent().css("color"), i = ($.plot($("#chart-revenue"), [
                {data: t}
        ...
        $.cookie("gritter_show") || ($.cookie("gritter_show", 1), setTimeout(function () {
            var e = $.gritter.add({title: "Welcome to GoGoGrocer Dasboard!", text: "What a beautiful day! I love you guys!", sticky: !0, time: "", class_name: "my-sticky-class"});
            setTimeout(function () {
                $.gritter.remove(e, {fade: !0, speed: "slow"})
            }, 12e3)
        }, 2e3), setTimeout(function () {
            var e = $.gritter.add({title: "You have 6 new orders", text: "#13457 #76977 #098787 #076711 #769876 #65797", sticky: !0, time: "", class_name: "my-sticky-class"});
            setTimeout(function () {
                $.gritter.remove(e, {fade: !0, speed: "slow"})
            }, 13e3)
        }, 8e3), setTimeout(function () {
            $.extend($.gritter.options, {position: "top-left"});
            var e = $.gritter.add({position: "top-left", title: "There are 3 customers waiting for you outside", text: "They are #65768 #65765 #798787", sticky: !0, time: "", class_name: "my-sticky-class"});
            $.extend($.gritter.options, {position: "top-right"}), setTimeout(function () {
                $.gritter.remove(e, {fade: !0, speed: "slow"})
            }, 15e3)
        }, 15e3), setTimeout(function () {
            $.extend($.gritter.options, {position: "top-left"});
            var e = $.gritter.add({title: "Congrats! New users!!!", text: "You have 16 new users today", sticky: !0, time: "", class_name: "my-sticky-class"});
            setTimeout(function () {
                $.gritter.remove(e, {fade: !0, speed: "slow"})
